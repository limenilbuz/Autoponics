...
private:
    ...
    int neutral_ph_mv = 1290;    // THESE TWO VALUES HAVE TO BE TESTED WITH KNOWN PH SOLUTION
    int acidic_ph_mv = 1760;     // FOR NEUTRAL, FIND THE mV AT PH 7, FOR ACIDIC, FIND THE mV AT PH 4
